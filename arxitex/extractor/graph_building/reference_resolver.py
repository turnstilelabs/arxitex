...
class ReferenceResolver:
    ...
    def resolve_all_references(self, project_dir: Path, nodes: List[ArtifactNode], 
                               label_to_node_id_map: Dict[str, str]) -> Tuple[List[Edge], List[ArtifactNode]]:
    ...
    def _extract_references_from_node(self, node: ArtifactNode, bib_map: Dict[str, Dict]) -> List[Reference]:
    ...
    def _create_graph_links(self, nodes: List[ArtifactNode], 
                            label_to_node_id_map: Dict[str, str]) -> Tuple[List[Edge], List[ArtifactNode]]:
        edges: List[Edge] = []

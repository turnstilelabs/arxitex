...
class DownloaderWorkflow(AsyncArxivWorkflowRunner):
    ...
    """
    def __init__(self, components: ArxivPipelineComponents, 
                 max_concurrent_tasks: int = 20, force: bool = False):
    ...
    async def _process_single_item(self, item: dict) -> dict:
        ...
        try:
            ...
            logger.info(f"SUCCESS: Downloaded source for {arxiv_id} to {extracted_path}")

...
from arxitex.detector.stupid_lemmas.stupid_lemmas_detection_models import StupidLemmaDetectionResult
from arxitex.detector.stupid_lemmas.stupid_lemmas_prompt import StupidLemmaDetectionPromptGenerator
